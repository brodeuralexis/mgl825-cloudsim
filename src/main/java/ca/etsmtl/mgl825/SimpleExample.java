...
public class SimpleExample {
    private static final int CLOUDLETS_COUNT = 30;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // The list of vms
            List<Vm> vms = createVM(brokerId, 15, 1);
            ...
            List<Cloudlet> cloudlets = createCloudlet(brokerId, CLOUDLETS_COUNT, 1); // creating 15 cloudlets
